...
if(isset($_POST['search'])){
    ...
    $f_desde = $_POST['desde'];
    $f_hasta = $_POST['hasta'];
    $sql = "(select * from alumnos where fecha >= '".$fecha."' and fecha < '".$fecha_sig."' and no_control like '%".$ncontrol."%' and fecha between '".$f_desde."' and '".$f_hasta."')";
    ...
    if ($ncontrol == "") {
        $sql = "(select * from alumnos where fecha >= '".$fecha."' and fecha < '".$fecha_sig."' and fecha between '".$f_desde."' and '".$f_hasta."')";
            $resultado = $conn->query($sql);
    }
    if ($ncontrol == ""){
        if ($f_desde == "") {
